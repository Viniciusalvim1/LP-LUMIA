      ...
      <div className="relative z-10 flex items-center min-h-[820px] pt-[96px] pb-16">
        <div className="w-full max-w-[1200px] mx-auto px-5 lg:px-12">
          <div className="w-full lg:max-w-[500px]">
            ...
            <motion.div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6 mb-6" {...fadeUp(0.4)}>
              <a
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-[14px] underline underline-offset-4 transition-colors duration-200 cursor-pointer"
                style={{
                  fontFamily: "var(--font-display)",
